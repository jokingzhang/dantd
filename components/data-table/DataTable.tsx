...
function DataTable<T>(props: IDataTableProps<T>) {
  ...
  async function fetchData(params?: any) {
    ...
    if (fetchUrl.indexOf('?') !== -1) {
      ...
      fetchUrl = fetchArr[0];
      customFetchParams = queryString.parse(fetchArr[1], { arrayFormat: 'comma' });
    }
    ...
    fetchUrl = `${fetchUrl}?${queryString.stringify(fetchParams, { arrayFormat: 'comma' })}`;
